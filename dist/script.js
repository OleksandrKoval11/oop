  ...
  bindTriggers() {
    this.btns.forEach(item => {
      ...
      item.parentNode.previousElementSibling.addEventListener('click', e => {
        if (!item.parentNode.previousElementSibling.getAttribute('data-first')) {
          this.slideIndex = 1;
...
/* harmony import */ var _modules_playVid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/playVid */ "./src/js/modules/playVid.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  showUpSlider.init();
  const modulesSliders = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  modulesSliders.init();
  const feedSliders = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  feedSliders.init();
  new _modules_playVid__WEBPACK_IMPORTED_MODULE_1__["default"]('.showup .play', '.overlay').init();
  new _modules_playVid__WEBPACK_IMPORTED_MODULE_1__["default"]('.module__video-item .play', '.overlay').init();
